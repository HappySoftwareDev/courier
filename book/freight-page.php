        ...
        <div class="container-fluid">
          ...
          <div class="row">
           ...
           <div class="card-style mb-30">
            ...
            <form action='#' method="POST" id="multiphase" onsubmit="showLocation();calcRoute(); return false" name="bookingform">
              <div id="phase1">
                    ...
                    <input id="inter_charge" value="<?php echo $inter_charge; ?>" type="hidden">
...
<div class="row">
    <div class="col-lg-6">
        <div class="select-style-1">
            ...
            <div class="select-position">
                <select name="insure" id="insure" onchange="calculateTotal()">
                    <option></option>
...
<!-- end row -->
 ...
 <!-- ===================== end phase two ===================== -->
  ...
  <div id="phase3">
    ...
    <input type="hidden" name="vehicle_type" class="form-control" value="Freight Delivery" required />
...
<!-- ============================ form end ========================================== -->
    ...
    <script type="text/javascript">
        ...
        function getInsurancePrice() {
          ...
          var selectedInsurance = _("insure").value;
        ...
        function calculateTotal(chk = 0) {
            ...
            var inter_price = _('delivery_type').value
            var inter_price_add = 1;
            if (inter_price == 'International') {
                inter_price_add = _('inter_charge').value;
            }
            if (price_in == "RTGS") {
                if (chk > 0) {
            ...
            _('tp_phase1').innerHTML = (roundTp * inter_price_add).toFixed(2);
            _('tp_phase2').innerHTML = (roundTp * inter_price_add).toFixed(2);
            _('tp').innerHTML = (roundTp * inter_price_add).toFixed(2);
            _('tpp').value = (roundTpp * inter_price_add).toFixed(2);
        }
        ...
        function submitForm() {
            ...
            if (transport.length < 3 && weight_of_package.length < 0 && value_of_package.length < 4 && trucks_num.length < 4) {
                ...
                _("multiphase").action = "submit_freight.php";
                _("multiphase").submit();
            }
        }
    ...
    <script type="text/javascript">
        ...
        function SendQuote() {
            ...
            var data = "address=" + address_e + "&drop_address=" + drop_address_e + "&email=" + email_e +
                "&Total_price=" + Total_price + "&distance=" + distance_e + "&delivery_type=" + delivery_type_e + "&weight=" + weight_e + "&trucks_num" + trucks_num_e + "&insurance=" + insure_e;
        ...
        function SendMsg() {
            ...
            var delivery_type_e = "Freight";
            window.open('sms:' + number_e + '?&body=Hi, Merchant Couriers freight delivery quotation.' +
                '\n *Pick up:* ' + address_e +
                ...
                ',\n https://merchantcouriers.com/freight.booking.php',
                '_self');
        ...
        function sendWhatsApp() {
            ...
            var currency_e = _("price_in").value
            var delivery_type_e = "Freight";
            window.open('https://api.whatsapp.com/send?text=Hi, Merchant Couriers freight delivery quotation. ' +
                '\n *Pick up:* ' + address_e +
                ',\n *Drop off:* ' + drop_address_e +
                ',\n *Truck No:* ' + trucks_num_e +
                ',\n *Truck size:* ' + weight_e +
