...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Sign Up | Merchant Couriers</title>
              ...
              <div class="auth-cover-wrapper bg-primary-100">
                <div class="auth-cover">
                  <div class="title text-center">
                    ...
                    <p class="text-medium">
                      You're one step away from enjoying our 
                      <br class="d-sm-block" />
                       one minute booking platform.
                    </p>
                  </div>
                      ...
                      <div class="col-12">
                        <div class="form-check checkbox-style mb-30">
                          ...
                          <label
                            ...
                            By ticking the box you declare that you agree to abide by our terms and conditions to use Merchant Couriers Technology and Mobile Apps to send LEGAL FREIGHT shipment requests only.<a href="terms.php" target='_blank'> Terms of Use</a></label>
                        </div>
                      </div>
                      <!-- end col -->
