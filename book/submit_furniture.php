            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title d-flex align-items-center flex-wrap mb-30">
                  <h2 class="mr-40">Furniture Booking</h2>
                </div>
              </div>
              <!-- end col -->
              <div class="col-md-6">
            ...
            ?>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <a href="paynow.php?orderD=<?= $aPost['order_number']; ?>&amount=<?= $aPost['Total_price']; ?>&ref=furniture">
                    ...
                    $uname = $smsUsername;
                    $pwd = $smsPwd; //"Merchant2017";
                    $id = $smsID; //"5cb7afb730f8fefe60780e67871c117f";
                    $sms_msg = "New Furniture delivery on Merchant Couriers. For more info check your email. Ref: $order_number, Price: $$dr_cost1 . Pay for your booking on Paynow.";
                    ...
                    $htmlContent2 = '
                                    ...
                                    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
                                		...
                                		<p>
                                	     New Furniture delivery order on Merchant  Couriers. Below are details of the order.
                                		</p>
                                		<table cellspacing="0" style="border: 2px dashed #FF8C00; width: 300px;">
                                			...
                                			<tr style="background-color: #e0e0e0;">
                                			<th>Lifters:</th><td>' . $insure . '</td>
                                			</tr>
                                
                                			<tr style="background-color: #e0e0e0;">
                                			<th>Total Price:</th><td>$' . $dr_cost1 . '</td>
                                			</tr>
                    ...
                    $email_ad = "merchantcouriers1@gmail.com";
                    $subject_ad = "New Order";
                    ...
                    // Send email
                    if (mail($email_ad, $subject_ad, $htmlContent_ad, $headers)) :
                        $successMsg = 'Email has sent successfully.';
                    else :
                        $errorMsg = 'Email sending fail.';
                    endif;
                    ...
                    $htmlContent = '
                                    ...
                                    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
                                        ...
                                        <h3>Furniture Delivery</h3>
                                		<p>
                                	     Congratulations! You have SUCCESSFULLY SUBMITTED a shipping request through Merchant Couriers. <br/> An email/sms notification confirming a transporter for your Shipping Request will be sent to you shortly. Upon which you will be expected to pay the required 50% deposit to initiate your shipment departur. <br/> We hold all deposits until transporter loads.
                                		</p>
                    ...
                    $htmlContent3 = '
                                ...
                                <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
                            		...
                            		<p>
                            	     Your client made a Furniture Delivery booking on Merchant  Couriers. Below are details of the booking.
                            		</p>
                            		<table cellspacing="0" style="border: 2px dashed #FF8C00; width: 300px;">
                                        <tr style="background-color: #e0e0e0;">
                            			<th>Order Number:</th><td>#' . $order_number . '</td>
                    ...
                    <h4>You'l receive a notification confirming a verified transporter.</h4>
                    <h4>If you have any questions contact +263779495409.</h4>
