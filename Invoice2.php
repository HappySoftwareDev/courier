                ...
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <section class="content-header">
                                        ...
                                        <button class="btn btn-warning pull-right" style="margin-right: 5px;"><?php echo $invoice; ?></button>
                                    </section>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            ...
                            <a href="https://www.paynow.com/Payment/Link/?q=c2VhcmNoPWhhcHB5ZzIlNDBsaXZlLmNvbSZhbW91bnQ9MC4wMCZyZWZlcmVuY2U9Jmw9MA%3d%3d"><button class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Submit Payment</button> </a>
