...
if (isset($_GET['orderD'])) {
    ...
    $run = mysql_query($get, $Connect);

    while ($row_type = mysql_fetch_array($run)) {
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "atPickForm")) {
    $updateSQL = sprintf(
        "UPDATE bookings SET status=%s, username=%s WHERE order_id=%s",
    ...
    $from = "orders@merchantcouriers.co.zw";
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
		...
		<p>
	    Hey ' . $clientName . ' <br/> Taxi driver ' . $driverName . ' is ON THE WAY to your Pick Up Address. An email/sms notification will be sent as soon as he arrives.
		</p>
    ...
    $message_to_cust = "Hey $clientName. Taxi driver $driverName is ON THE WAY to your Pick Up Address. An email/sms notification will be sent as soon as he arrives.";
    ...
    $updateGoTo = "acceptedOrdersDetails.php";
    if ($updateGoTo) {
        echo "<script>alert('Notification sent!')</script>";
        echo "<script>window.open('taxi.afterPick.php','_self')</script>";
    } else {
        echo "<script>alert('error!')</script>";
    }
}

if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "cancelForm")) {
    $updateSQL = sprintf(
        ...
        <section id="main-content">
            ...
            <div class='btn-group btn-block'>
                ...
                <ul class='dropdown-menu pull-right' role='menu'>
			       ...
			       <li class='list-group-item'><b>Name:</b> $client_name<br></li>
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form method="POST" action="<?php echo $editFormAction; ?>" name="atPickForm">
                                    ...
                                    <li class='list-group-item'>
                                        <button class='btn btn-success btn-lg btn-block' name="atPick" type="submit"><span class='fa fa-car'></span> on the way</button>
                                        <input type="hidden" name="MM_update" value="atPickForm">
                                </form>
                                </li>


                                <form method="POST" action="<?php echo $editFormAction; ?>" name="cancelForm">
