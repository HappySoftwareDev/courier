...
if (isset($_POST["MM_update"])) {
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
		...
		<p>We Deliver With Speed.</p>
                ...
                $headers .= 'Bcc: admin@merchantcouriers.co.zw' . "\r\n";
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form method="POST" action="freight_order_details.php" name="acceptForm">
                                    ...
                                    <input type="hidden" class="form-control" name="number_of_trucks" placeholder="Enter the number of trucks available">
                                    <input type="hidden" class="form-control" name="date_available" placeholder="Date your truck is availble">
                                    <input type="hidden" class="form-control" name="bid_price" value="<?php echo $cost1; ?>" placeholder="Enter Your bid price">
                                    <input type="hidden" class="form-control" name="shot_desc" placeholder="Enter a shot description of your offer" value="Will deliver your goods safely and in time." />
