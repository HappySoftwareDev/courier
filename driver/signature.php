...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "completeSignature")) {
    ...
    try {
        ...
        if ($count == 1) {
            $stmt = $DB_con->prepare("UPDATE `bookings` SET status=:status, status_update_date=:status_update, ReciepientName=:ReciepientName, ReciepientSignature=:ReciepientSignature, username=:username, proof_img=:name_image WHERE order_number=:order_id");
            ...
            if ($stmt->execute()) {
                ...
                $toAD = "merchantcouriers1@gmail.com";
                ...
                $headerrs = "orders@merchantcouriers.com";
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
		...
		<p>
	   Thank You for using Merchant Couriers. ORDER COMPLETED Successfully and your stuff has been DELIVERED to ' . $drop_name . '.
		</p>
		<p></p>
		<footer>
		...
		<p>We Deliver With Speed.</p>
                    ...
                    $message_to_cust = "Arrived to your destination safely. Thank You for Using Merchant Couriers feel free to tell your loved  ones about our services.";
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
        ...
        <h3>We Deliver With Speed!</h3>
		<p>
	   ORDER COMPLETED Successfully. On this delivery you made ' . $driver_amount . '.
		</p>
		<p>Thank You for being part of Merchant Couriers.</p>
		<footer>
		<div style="background-color:#CCC; padding:10px;">
		<p>
		For any further inquiries please contact us via the contact page on our website www.merchantcouriers.com. Alternatively you can call/whatsapp on +263772467352 or +263779495409. <br/>
		...
		<p>We Deliver With Speed.</p>
                    ...
                    $sms_phone = $_POST['driverphone'];
                    $uname = "Business";
                    $pwd = "Merchant2017";
                    $id = "b5c57830717b41b6c8b038912a55e641";
                    $sms_msg = "Thank You for Using Merchant Couriers. ORDER COMPLETED Successfully you made $driver_amount";
                    $data = "&u=" . $uname . "&h=" . $id . "&op=pv&to=" . $sms_phone . "&msg=" . urlencode($sms_msg);
                ...
                $msg ="Thank you for using Merchant Couriers. ORDER COMPLETED successfully.";
                $page="new_orders.php";
