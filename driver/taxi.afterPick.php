...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "onWayForm")) {
    $updateSQL = sprintf(
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
		...
		<p>
	    Hey ' . $clientName . ' <br/> Taxi driver ' . $driverName . ' has arrived at your Pick Up Address.
		</p>
    ...
    $message_to_cust = "Hey $clientName. Taxi driver $driverName has arrived at your Pick Up Address.";
    ...
    if ($updateGoTo) {
        ...
        echo "<script>window.open('taxi.onLiveJob.php','_self')</script>";
    } else {
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form method="POST" action="<?php echo $editFormAction; ?>" name="onWayForm">
                                    <input type="hidden" class="form-control" name="status" value="at pick">
                                    ...
                                    <li class='list-group-item'>
                                        <button class='btn btn-warning btn-lg btn-block' name="onWay" type="submit"><span class='icon_check_alt2'></span> At Pick Up</button>
