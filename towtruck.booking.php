...
$MM_restrictGoTo = "towtruck.login.php";
...
<head>
    ...
    <title>Quick Booking Tow Truck Recovery Vehicle| Merchant Couriers</title>
    <meta name="Are you stranded and would like to book a tow truck fast in zimbabwe, try Merchant Couriers. We will send a tow truck your way very fast." content="book online, tow truck, recovery, transport service, zimbabwe ">
    <meta name="viewport" content="width=device-width">

    <link re="canonical" href="https://www.merchantcouriers.co.zw/towtruck.booking.php" />
    ...
    <script type="text/javascript">
        ...
        quantity_prices["0"] = 0;
        quantity_prices["Van"] = 3.99;
        quantity_prices["Small Car"] = 2.59;
        quantity_prices["Truck"] = 8.39;
        quantity_prices["Bus"] = 13.49;

        var car_prices = new Array();
        car_prices["0"] = 0;
        car_prices["Hook and Chain Tow Trucks"] = 6.50;
        car_prices["Wheel-Lift Tow Truck"] = 7.00;
        car_prices["Integrated Tow Truck"] = 10.00;
        car_prices["Flatbed Tow Trucks"] = 15.50;
        ...
        function submitForm() {
            ...
            if (transport.length < 3 && package_quantity.length < 4 || drop_time == "") {
                ...
                _("multiphase").action = "towtruck.submit_parser1.php";
                _("multiphase").submit();
            }
        }
...
<body>
    ...
    <section class="title">
        <div class="container">
            <div class="row-fluid">
                <div class="span6">
                    <h1>Book A Tow Truck</h1>
                </div>
                <div class="span6">
                    <ul class="breadcrumb pull-right">
                        <li><a href="index.html">Home</a> <span class="divider">/</span></li>
                        <li><a href="#">Pages</a> <span class="divider">/</span></li>
                        <li class="active">Booking Tow Truck</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
                ...
                <fieldset class="registration-form">
                    ...
                    <form action="<?php echo $editFormAction; ?>" method="POST" id="multiphase" onsubmit="showLocation();calcRoute(); return false" name="bookingform">
                        <div id="phase1">
                            <input id="totalp" value="<?php echo $towtruck_per_km; ?>" type="hidden">
                        ...
                        <div id="phase3">
                            ...
                            <select name="time" id="time" class="input-block-level">
                                ...
                                <option>9:00 pm - to - 10:00 pm</option>
                                <option>10:00 pm to - 11:00 pm</option>
                                <option>11:00 pm - to - 12:00 am</option>
                            </select>
                            ...
                            <label>Type Of Vehicle to be towed</label>
                            <select class="input-block-level" name="vehicle_type" id="package_quantity" onchange="calculateTotal()">
                            ...
                            <select name="transport" id="transport" required="required" class="input-block-level" onchange="calculateTotal()">
                                <option value="0"></option>
                                <option value="Hook and Chain Tow Trucks">Hook and Chain Tow Trucks </option>
                                <option value="Wheel-Lift Tow Truck">Wheel-Lift Tow Truck </option>
                                <option value="Integrated Tow Truck">Integrated Tow Truck </option>
                            ...
                            <input type="hidden" name="delivery_type" class="form-control" value="Tow Truck" required />
                            <label>Add a short description of your Vehicle</label>
                            <textarea rows="6" class="input-block-level" placeholder="Add a short description of your Vehicle" id="note" name="note"></textarea>
                            ...
                            <input type="submit" class="btn btn-success btn-large btn-block" onclick="submitForm()" value="Book a Tow Truk">
