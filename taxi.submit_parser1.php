...
<body>
    ...
    <section Style="background-color:#193b50" id="services">
        <div class="container">
            ...
            $get = "SELECT * FROM `driver` WHERE type_of_service='Taxi' AND username !='pending' AND info !='blocked' ";
            ...
            if (isset($_POST['MM_insert'])) {
                ...
                $message_to_cust = "New Taxi Booking on Merchant Couriers. For more info check your email. Ref: $order_number, Price: $Total_price . Pay for your booking on Paynow.";
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
		...
		<p>
	     New Taxi booking on Merchant  Couriers. Below are details of the booking.
		</p>
		<table cellspacing="0" style="border: 2px dashed #FF8C00; width: 300px;">
			...
			<tr style="background-color: #e0e0e0;">
			<th>Number Of People:</th><td>' . $package_quantity . '</td>
			</tr>
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
        ...
        <h3>We Deliver With Speed!</h3>
		<p>
	     Congratulations! You have SUCCESSFULLY BOOKED a taxi through Merchant Couriers. <br/> An email/sms notification with a taxi driver assigned to you will be sent to you shortly.
		</p>
       ...
       <h3> Click this link <a href="https://www.merchantcouriers.co.zw/taxi.invoice.php?taxibooking=' . $order_number . '">Invoice</a> to see your invoice if you didn`t pay the booking.</h3>
		...
		<p>We Deliver With Speed.</p>
            ...
            ?>
                ...
                <h1>Thank you for booking your taxi with Merchant Couriers. <br /></h1> <br /><br />
    ...
    <?php require ("get-sql-value.php"); 
            ...
            if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "bookingform")) {
                $insertSQL = sprintf(
                    "INSERT INTO bookings (pick_up_address, pick_up_time, pick_up_date, Name, phone, email, drop_address, drop_time, Total_price, distance, quantity, type_of_transport, order_number, delivery_type, drivers_note) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                    ...
                    GetSQLValueString($_POST['package_quantity'], "text"),
                ...
                $message_to_cust = "You've just booked a taxi using Merchant Couriers. For more info check your email. Ref: $order_number, Price:$Total_price . Pay for your booking on Paynow.";
                ...
                if ($insertGoTo) {
                    ...
                    echo "<script>window.open('taxi.invoice.php?taxibooking=$book_num','_self')</script>";
                } else {
