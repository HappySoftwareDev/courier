...
<body>
    ...
    <?php require ("get-sql-value.php"); 
            ...
            if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "partnerform")) {
                $insertSQL = sprintf(
                    "INSERT INTO businesspartners (businessName, email, phone, businessLocation, businessType, software_packages, estimateDeliveries, pick_up_address, deliveryTime, PreferedTransport, company_logo, NameOfContact, PersonPhone, password) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mail($to, '', $message, $headers );8*/
            ...
            ?>
                ...
                <h2>Thank you for your interest to deliver with us, we will be in touch asap.</h2> <br /><br />
