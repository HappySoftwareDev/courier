...
<head>
  ...
  <title>Merchant Couriers eCommerce Integration | Registration Page</title>
...
<div class="register-box">
    ...
    <div class="card-body register-card-body">
      ...
      <form action="<?=base_url()?>/register" method="post">
        <div class="input-group mb-3">
          <input name="name" required type="text" class="form-control" placeholder="Full name" value="<?=set_value('name')?>">
        ...
        <div class="input-group mb-3">
          <input name="email" required type="email" class="form-control" placeholder="Email" value="<?=set_value('email')?>">
          <div class="input-group-append">
            <div class="input-group-text">
  ...
  <optgroup label="Other countries">
    ...
    <option data-countryCode="ZM" value="260">Zambia (+260)</option>
        ...
        <div class="input-group mb-3">
          <input type="tel" placeholder="Phone Number" class="form-control input-block-level" id="number" value="<?=set_value('phone')?>" name="phone" required>
        ...
        <div class="input-group mb-3">
          <input name="repassword" required type="password" class="form-control" placeholder="Retype password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
          ...
          <div class="col-8">
            <div class="icheck-primary">
              ...
              <label for="agreeTerms">
               I agree to the <a target="_blank" href="https://merchantcouriers.com/apiterms.php">terms</a>
              </label>
            </div>
          </div>
          <!-- /.col -->
        ...
        <button onclick="codeverify();" type="submit" class="btn btn-success btn-large btn-block" >Verify code</button>
        </div>
          <!-- /.col -->
        </div>
      </form>
