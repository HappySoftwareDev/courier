        ...
        <div class="card card-default">
          <div class="card-header">
          	<?php if (session()->getFlashdata('error')): ?>
          		<p class="alert-danger text-center"><?=session()->getFlashdata('error')?></p>
          	<?php endif ?>
            <?php if (session()->getFlashdata('msg')): ?>
              <p class="alert-success text-center"><?=session()->getFlashdata('msg')?></p>
          ...
          <div class="card-body">
            ...
            <div class="row">
              	<div class="col-md-6">
	                  ...
	                  <label>Old Pallword*</label>
	                  <input type="password" class="form-control" name="oldpassword" id="oldpassword" style="width: 100%;" required >
              		</div>
          		</div>
              	<div class="col-md-6">
	              	<div class="form-group">
	                  <label>New Password*</label>
	                  <input type="password" class="form-control" name="newpassword" id="newpassword" style="width: 100%;" required>
              		</div>
          		</div>
              	<div class="col-md-6">
	              	<div class="form-group">
	                  <label>Confirm password*</label>
	                  <input type="password" class="form-control" name="c_password" id="c_password" style="width: 100%;" required value="">
              		</div>
          		</div>
