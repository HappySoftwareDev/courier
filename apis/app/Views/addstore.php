    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            	<form method="post" action="<?=base_url()?>/add-stores">
            <div class="row">
              	<div class="col-md-6">
	              	<div class="form-group">
	                  <label>Business Name*</label>
	                  <input type="text" class="form-control" name="business_name" id="business_name" style="width: 100%;" required value="<?=set_value('business_name')?>">
              		</div>
          		</div>
              	<div class="col-md-6">
	              	<div class="form-group">
	                  <label>Business Email*</label>
	                  <input type="email" class="form-control" name="business_email" id="business_email" style="width: 100%;" required value="<?=set_value('business_email')?>">
              		</div>
          		</div>
              	<div class="col-md-6">
	              	<div class="form-group">
	                  <label>Phone*</label>
	                  <input type="text" class="form-control" name="phone" id="phone" style="width: 100%;" required value="<?=set_value('phone')?>">
              		</div>
          		</div>
              	<div class="col-md-6">
	              	<div class="form-group">
	                  <label>Contact Person*</label>
	                  <input type="text" class="form-control" name="contact_person" id="contact_person" style="width: 100%;" required value="<?=set_value('contact_person')?>">
              		</div>
          		</div>
              	<div class="col-md-6">
	              	<div class="form-group">
	                  <label>Business adddress*</label>
	                  <input id="autocomplete" class="form-control input-block-level" placeholder="Enter your address" type="text" name="address" onFocus="geolocate()"  style="width: 100%;" required value="<?=set_value('address')?>">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <!-- <input id="area" class="form-control input-block-level" placeholder="" type="text" name="address" onFocus="geolocate()"  style="width: 100%;" required value="<?=set_value('address')?>"> -->
  ...
  <optgroup label="Other countries">
    ...
    <option data-countryCode="ZM" value="260">Zambia (+260)</option>
              ...
              <div class="col-md-6">
                  ...
                  <input type="tel" placeholder="Phone Number" class="form-control input-block-level" id="number" name="phone" required>
          
              </div>
              <div id="recaptcha-container"></div>
            <!-- <div id="auth_stepp"> -->
          <div class="col-12" id="auth_stepp">
            <button onclick="phoneAuth();" id="sign-in-button" class="btn btn-primary btn-block" >Next</button>
            <!-- <button type="submit" class="btn btn-primary btn-block">Register</button> -->
          </div>
            <div id="verify_stepp" class=" col-12" style="display: none;">
        <label>Enter Verification code</label>
                  <input type="text" class="form-control" placeholder="Varification Code" id="verificationCode" required>
                  
              
	              	<div class="form-group text-right">
	                  <!-- <label>Business adddress</label> -->
	                  <input  onclick="codeverify();" class="btn btn-info" type="submit" name="submit">
	                  <!-- <input type="text" class="form-control" name="contact_person" id="contact_person" style="width: 100%;"> -->
              		</div>
          		</div>
