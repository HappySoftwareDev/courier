...
<head>
  ...
  <title><?=$setting->site_title?> | <?=$title?></title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url()?>/profile" class="nav-link">Setting</a>
      </li> -->
    </ul>
...
<style type="text/css">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=base_url()?>/dashboard" class="brand-link">
      <img src="<?=base_url()?>/public/images/logo.png" alt="dashboard" style=" height: 100%; width: 40%;" class="brand-image elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Merchant Courier</span>
    </a>

    <!-- Sidebar -->
    <!-- <div class="sidebar" style="overflow-y:clip !important;"> -->
    <div class="" style="">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?=base_url()?>/dashboard" class="d-block" style="color: #fff;"><?=$username?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url()?>/my-stores" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                My Stores
                <span class="right badge badge-info"><?=count($storecount)?></span>
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?=base_url()?>/add-stores" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Add New Store
                <!-- <span class="right badge badge-info"><?=count($storecount)?></span> -->
          ...
          <li class="nav-item">
            <a href="<?=base_url()?>/my-orders" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                My Orders
                <!-- <span class="right badge badge-info"><?=count($storecount)?></span> -->
