...
if (isset($_POST['invite'])) {
    ...
    $message = "Hello you have been invited to become Admin at Merchant Couriers\n Follow the link below if you don't understant this email just ignore it.\n http://merchantcouriers.com/admin/pages/adiminUsers.php";
    $headers = 'From: ' . $from;
 ...
 if($push_token !=""){
    ...
    $msg ="Hello you have been invited to become Admin at Merchant Couriers";
    $page="users.php";
                            ...
                            <div class="col-lg-6">
                                <form role="form" method="POST" action="users.php">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">Invite a new user to manage this merchant.</p> <br />
                                        <label>Email</label>
                                        ...
                                        <p class="help-block">Only adminstrators are to be invited here.</p>
                                    </div>
                                </form>
