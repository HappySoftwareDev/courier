...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "invite")) {
    $insertSQL = sprintf(
        "INSERT INTO `customer_alerts`(`msg`, `subject`) VALUES (%s, %s)",
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
       ...
       <h3>Easly book a delivery <a href="merchantcouriers.com/mobile_apps/MerchantCouriersBooking.apk"><b>Download Booking app.</b></a></h3>
...
<head>
    ...
    <title>Merchant Couriers - Alerts</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <form role="form" method="POST" name="invite" action="customer_alerts.php">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">Send Email Alert to Customers.</p> <br />
                                        <label>Subject</label>
                                        ...
                                        <p class="help-block"> Send email alerts to all registered customers here.</p>
                                    </div>
                                </form>
                                <hr />
                            ...
                            <div class="col-lg-6">
                                <form role="form" method="POST" name="invite_sms" action="affiliate.alerts.php">
                                    <div class="form-group">
                                        <p><span id="sent"></span></p>
                                        <p class="help-block">Send SMS Alert to Customers.</p> <br />
                                        <label>Subject</label>
                                        <input type="text" class="form-control" name="subject" placeholder="Subject" required /><br />
                                        ...
                                        <p class="help-block"> Send sms alerts to all registered customers here.</p>
                                    </div>
                                </form>
                                <hr />
                            ...
                            if (isset($_GET['delete_custAlert'])) {
                                ...
                                $delet = "DELETE FROM `customer_alerts` WHERE `customer_alerts`.`id`='$delete_alert' ";
