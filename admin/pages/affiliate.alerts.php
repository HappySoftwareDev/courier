...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "invite")) {
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
		...
		<p>If you need help talk to us <a href="www.merchantcouriers.co.zw/contact-us.php">here.</p>
    ...
    echo "<script>window.open('affiliate.alerts.php','_self')</script>";
...
<head>
    ...
    <title>Merchant Couriers - Affiliates</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Affiliates Alerts</h1>
                        <div class="row">
                            <!-- /.col-lg-6 -->
                            <div class="col-lg-6">
                                <form role="form" method="POST" name="invite" action="affiliate.alerts.php">
                                    <div class="form-group">
                                        <p><span id="sent"></span></p>
                                        <p class="help-block">Send Email Alert to Affiliates.</p> <br />
                                        <label>Subject</label>
                                        ...
                                        <p class="help-block"> Send alerts to all affiliates here.</p>
                                    </div>
                                </form>
                                <hr />
                            ...
                            <!-- /.col-lg-6 -->
                            <div class="col-lg-6">
                                <form role="form" method="POST" name="invite_sms" action="affiliate.alerts.php">
                                    <div class="form-group">
                                        <p><span id="sent"></span></p>
                                        <p class="help-block">Send SMS Alert to Affiliates.</p> <br />
                                        <label>Subject</label>
                                        <input type="text" class="form-control" name="subject" placeholder="Subject" required /><br />
                            ...
                            <?php
                            if (isset($_GET['delete_affAlert'])) {

                                $delete_alert = $_GET['delete_affAlert'];

                                $delet = "DELETE FROM `affiliate_msg` WHERE `affiliate_msg`.`id`='$delete_alert' ";
