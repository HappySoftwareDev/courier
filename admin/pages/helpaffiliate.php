...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "msgAdForm")) {
    $insertSQL = sprintf(
        "INSERT INTO `affiliate_msg`(`name`, `msg`, `affiliate_no`, `subject`) VALUES (%s, %s, %s, %s)",
    ...
    $to = "customerservice@merchantcouriers.co.zw";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Help Messages</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            $get = "SELECT * FROM `affilate_msg` WHERE affiliate_no='$affiliate_no'";
            $run = mysqli_query($Connect, $get);
            while ($row_type = mysqli_fetch_array($run)) {
                $ID = $row_type['id'];
                $Name = $row_type['name'];
                $msg = $row_type['msg'];
                $affialte_no2 = $row_type['affiliate_no'];
            }
            ?>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="chat-panel panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-comments fa-fw"></i> Send Questions
                        ...
                        <div class="panel-footer">
                            <form action="<?php echo $editFormAction; ?>" method="POST" name="msgAdForm">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="affiliate_no" value="<?php echo $affiliate_no; ?>">
