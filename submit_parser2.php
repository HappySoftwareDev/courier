...
<?php require ("get-sql-value.php"); 
            ...
            if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "partnerform")) {
                $insertSQL = sprintf(
                    "INSERT INTO businesspartners (businessName, email, phone, businessLocation, businessType, estimateDeliveries, pick_up_address, deliveryTime, PreferedTransport, NameOfContact, PersonPhone, password) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mail($to, '', $message, $headers );8*/
            ...
            ?>
                ...
                <h2>SUCCESSS!!
                    <br />Thank you for your interest to use one of our software solution packages, your business fleet, driver and deliveries management will never be the same again. We will be in touch wih more information and your package solution within 24hrs.
                </h2> <br /><br />
