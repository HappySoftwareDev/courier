...
if (isset($_POST['email'])) {
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
        ...
        <h3></h3>
		<p>Hello<p/>
		<p>You are being invited to try our transportation services at <a href="https://<?php echo $web_url ?>/book/" ><?php echo ' . $web_url . '/book ; ?></a>  
        </p>
       ...
       <h3> <a href="https://<?php echo $web_url ?>/book/">Give it a try and enjoy convenient and affordable transporation services.</a> </h3>
