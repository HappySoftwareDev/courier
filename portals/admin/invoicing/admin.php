...
if (isset($_GET['status'])) {
    if (isset($_SESSION['payment'])) {
        ...
        if ($aPayment->status == true) {
            ...
            // Use PDO prepared statement instead of MySQLi string concatenation
                                    ...
                                    <section class="content invoice">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <h2 class="page-header">
                                                    <img src="images/logo.png" alt="" class="col-lg-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6">
                                                ...
                                                <a href="#"><img style="border: 0;" src="stripe.png" /></a>
                                                <a href="#"><img style="border: 0;" src="rtgs.png"></a>
            ...
            <script type="text/javascript">
                function pay(amount) {
                    var handler = StripeCheckout.configure({
                        ...
                        key: 'pk_live_WZ948TkMjcYzYuyifoTqF4R0', // your publisher key id
                        locale: 'auto',
                ...
                window.onload = pay(<?php echo $amount; ?>);
            </script>
