...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "partnerform")) {
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
       ...
       <h3> Click <a href="https://' . $web_url . '/affiliate.user/"><b>View details</b></a> to see more details about this client.</h3>
    ...
    // Additional headers
    $headers .= 'From: <?php echo $site_name ?><registrations@' . $web_url . '>' . "\r\n";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "partnerform")) {
    ...
    <div style="font-family:HelveticaNeue-Light,Arial,sans-serif;background-color:#eeeeee; padding:8px; text-align:centre;">
        ...
        <h3></h3>
		<p>
	     Welcome to ' . $site_name . ' thanks for signing up.
		</p>

       <h3> Book a delivery at anytime using your phone. </h3>
...
<head>
    ...
    <title>New customer registration for transport services| <?php echo $site_name ?></title>
    <meta name="author" content="<?php echo $site_name ?>">
    <meta name="keywords" content="register online,book online, transport service">
    ...
    <meta property="og:title" content="Become a <?php echo $site_name ?> driver">
    <meta property="og:image" content="https://<?php echo $web_url ?>/images/01.png">
    <meta property="og:description" content="Hey there! You are being invited to try our delivery driver services. If you own a motorbike, car, van, truck. Go ahead and signup and start earning extra money. Visit our website <?php echo $web_url ?> and register your vehicle today.">

    <link re="canonical" href="https://<?php echo $web_url ?>/freight.reg.php" />
...
<body>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row-fluid">
                <div class="span5 cp">
                    &copy; 2017 <a target="_blank" href="http://<?php echo $web_url ?>/"><?php echo $site_name ?></a>. All Rights Reserved.
                </div>
                <!--/Copyright-->

                <div class="span6">
                    <ul class="social pull-right">
                        <li><a href="http://www.facebook.com/sharer.php?u=https://<?php echo $web_url ?>" target="_blank"><i class="icon-facebook"></i></a></li>
                        <li><a href="https://twitter.com/share?url=https://<?php echo $web_url ?>&amp;text=<?php echo $site_name ?>&amp;hashtags=<?php echo $site_name ?>" target="_blank"><i class="icon-twitter"></i></a></li>
                        <li><a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=https://<?php echo $web_url ?>" target="_blank"><i class="icon-linkedin"></i></a></li>
                        <li><a href="https://plus.google.com/share?url=https://<?php echo $web_url ?>" target="_blank"><i class="icon-google-plus"></i></a></li>
